...
## Resumen de progreso en `Paper`.

| Componente | Script | Reporte |
|------------|--------|---------|
| Procesamiento de bases. | `Procesamiento_Bases.py` | Datos en `Paper\Datos definitivos`. |
| Analisis descriptivos. | `Analisis_Descriptivo.py` | `Analisis_Descriptivo.txt`. |
| Analisis estadisticos. | `Analisis_Estadisticos.py` | `Resultados_Analisis_Estadisticos.txt`. |
| Modelos estadisticos. | `Modelos.py` | `Proceso_Modelos.txt` y `Resultados_Modelos.txt`. |
| Correlaciones. | `Analisis_Correlaciones.py` | Pendiente. |

---

## Notas adicionales.

- Los primeros 3 IP_Items_Asociados unicos por participante
  se eliminan como periodo de warm-up.
- Las escalas de autopercepcion van de 1 a 10
  (Izquierda-Derecha, Conservador-Progresista,
  Peronista-Antiperonista).
- La cercania a candidatos usa escala de 1 a 5.
- Los IP_Items usan escala Likert de 1 a 5 (Muy de acuerdo
  a Muy en desacuerdo).